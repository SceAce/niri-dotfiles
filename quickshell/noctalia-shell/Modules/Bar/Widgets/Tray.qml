        ...
        MouseArea {
          ...
          onClicked: mouse => {
                       ...
                       if (mouse.button === Qt.LeftButton) {
                         ...
                         if (modelData.hasMenu && modelData.display && tooltipAnchor.Window && tooltipAnchor.Window.window) {
                           const windowPos = tooltipAnchor.mapToItem(null, 0, 0);
                           let menuX = windowPos.x + Math.round(tooltipAnchor.width / 2);
                           let menuY = windowPos.y + Math.round(tooltipAnchor.height / 2);

                           if (barPosition === "left") {
                             menuX = windowPos.x + tooltipAnchor.width;
                           } else if (barPosition === "right") {
                             menuX = windowPos.x;
                           } else if (barPosition === "top") {
                             menuY = windowPos.y + tooltipAnchor.height;
                           } else if (barPosition === "bottom") {
                             menuY = windowPos.y;
                           }

                           modelData.display(tooltipAnchor.Window.window, menuX, menuY);
                         } else if (modelData.hasMenu && modelData.menu && trayMenu && trayMenu.item) {
                           ...
                           // Some tray items expose their context menu through the secondary
                           // activation path instead of a DBus menu handle.
